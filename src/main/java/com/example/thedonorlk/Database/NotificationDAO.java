...
public class NotificationDAO {
    ...
    private static final String INSERT_SQL = "INSERT INTO notification (ID, Notifyee_ID, Notifier_ID, Type, Message, DateTime) VALUES " +
            " (?, ?, ?, ?, ?, ?)";
    ...
    public boolean insertNotificaion(NotificationBean notification) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = con.prepareStatement(INSERT_SQL)) {
            ...
            preparedStatement.setInt(2, notification.getNotifyee_id());
            preparedStatement.setInt(3, notification.getNotifier_id());
            preparedStatement.setString(4, notification.getType());
            preparedStatement.setString(5, notification.getMessage());
            preparedStatement.setString(6, sqlDate + " " + sqlTime);
