...
@WebServlet("/bloodRequestSent")
public class BloodRequestSentServlet extends HttpServlet {
    ...
    private void listUser(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("./view/non_donor/request_sent.jsp");
