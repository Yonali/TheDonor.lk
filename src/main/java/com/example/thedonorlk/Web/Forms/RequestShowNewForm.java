...
@WebServlet("/requestShowNewForm")
public class RequestShowNewForm extends HttpServlet {
    ...
    private void showNewForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("./view/non_donor/requestForm.jsp");
