...
@WebServlet("/bloodTransferingShowForm")
public class BloodTransferingShowForm extends HttpServlet {
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("./view/non_donor/stockTransferForm.jsp");
