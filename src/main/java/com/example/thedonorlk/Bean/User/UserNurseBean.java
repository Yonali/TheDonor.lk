...
public class UserNurseBean {
    ...
    public UserNurseBean(int id, String username, String first_name, String last_name, String contact,String blood_group, String nic, String email, String section, String bloodbank_code) {
        this.id = id;
