            ...
            <div class="col-1-2">
                <div class="dropdown">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        <a href="<%=request.getContextPath()%>/donorTimeline" target="mainframe"
                           onclick="timelineSelect()">Timeline</a>
                        <a href="<%=request.getContextPath()%>/emergency_donor" target="mainframe"
                           onclick="emergencySelect()">Emergency</a>
...
<%--            </div>--%>
        ...
        <div class="col-3">
            <div class="col-3-1">
                <a href="<%=request.getContextPath()%>/notification" class="notification" target="mainframe"
                   onclick="notificationSelect()">
