        ...
        <div class="column container_more <c:out value="${emergency.bloodbank_code}"/>">
            ...
            <div class="post-module">
                ...
                <div class="post-content">
                    ...
                    <h1 class="title">#1562 <br>Date - <c:out value="${emergency.date}"/> <br>Time - <c:out value="${emergency.time}"/></h1>
                    <h2 class="sub_title"><c:out value="${emergency.bloodbank_name}"/></h2>
