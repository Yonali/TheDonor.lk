...
<body>
    <div class="maincontainer">
        <nav class="navcontainer">
            <div class="col-1">
                <div class="logo">
                    <img src="../public/images/Logo.png" height="75px">
                </div>
                <!-- ---------------------responsive logo------------------------------- -->
                <div class="logo_responsive">
                    <img src="../public/images/Logo.png" height="45px" width="85px">
                </div>
                 <!-- ---------------------responsive logo------------------------------- -->
                <div class="col-1-2">
                    <div class="dropdown">
            ...
            <div class="col-3">
                ...
                <div class="dropdown">
                    <div class="col-3-2">
                        <img src="../public/images/anne-doe.jpg" id="PP" style="width:50px;height:50px;">
                        <div class="d col-3-3">
                            <a href="#">Anne Doe</a>
                        </div>
                    </div>
                ...
                <div class="dropdown_responsive">
                    <div class="col-3-2">
                        <img src="../public/images/anne-doe.jpg" id="PP" style="width:35px;height:35px;">
                        <a href="#">Anne Doe</a>
                        <div class="d col-3-3">
