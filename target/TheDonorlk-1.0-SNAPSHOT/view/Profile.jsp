    ...
    <div class="frame">
        <div class="contentbox">
            <div class="donor">    
                <div class="sub_donor">
                    <div class="dn_pp">
                        <img src="../public/images/postdp.jpg" id="PP" style="width:95px;height:95px;margin-top: 8px; margin-left: 320px;">
                    </div>
                    <div class="dnametl">
                        <a href="#">Jenny Doe</a>                   
                    </div>
                ...
                <div class="posts">
                    <div class="singlepost">
                        <div class="Profilename">
                            <img src="../public/images/postdp.jpg" id="PP" style="width:60px;height:60px;">
                            <a href="#">Jenny Doe</a>
                        ...
                        <div class="imgOrV">
                                    <img src="../public/images//postpic.jpg" id="PP1" style="width:400px;height:300px;">
                        </div>
                         <!-- --------------------------------responsive------------------------------------- -->
                         <div class="imgOrV_responsive">
                            <img src="../public/images//postpic.jpg" id="PP1_r" style="width:300px;height:250px;">
                          </div>
                          <!-- --------------------------------responsive------------------------------------- -->
                        <div class="footer">
                            ...
                            <div class="A_container">
                                <div class="main_edit_div">
                                    ...
                                    <div class="edit_div1">
                                        ...
                                        <img src="../public/images/postdp.jpg" id="PP" style="width:120px;height:120px;">
                                    </div>
